...
export const indicatorsData = [
  ...
  {
    id: "move",
    name: "Volatilidad Bonos (MOVE)",
    detailName: "Merrill Lynch Option Volatility Estimate (MOVE)",
    value: "115.40",
    change: "+2.1%",
    changeType: "up",
    status: "neutral",
    subscore: 50,
    weight: weights.move,
    description: "Es el 'VIX de los bonos'. Mide la volatilidad implícita en las opciones de los bonos del Tesoro de EE.UU. Un MOVE elevado indica incertidumbre sobre los tipos de interés y suele preceder a episodios de inestabilidad en las bolsas.",
    history: generateTrendData(100, 25, 0.005, 2),
  },
  {
    id: "credito",
  ...
  {
    id: "cds_us",
    name: "Riesgo Impago EE.UU. (HY)",
    detailName: "US High Yield OAS (Proxy CDS US)",
    value: "3.85%",
    change: "+0.15%",
    changeType: "up",
    status: "neutral",
    subscore: 55,
    weight: weights.cds_us,
    description: "Mide el diferencial de crédito de los bonos americanos de alto rendimiento (High Yield). Es el mejor barómetro de riesgo de impago corporativo; si sube de forma agresiva, suele anticipar problemas sistémicos o recesión.",
    history: generateTrendData(4, 25, -0.0001, 0.1),
  },
  {
    id: "cds_eu",
    name: "Riesgo Impago Europa",
    detailName: "Euro High Yield OAS (Proxy CDS EU)",
    value: "4.10%",
    change: "+0.08%",
    changeType: "up",
    status: "neutral",
    subscore: 50,
    weight: weights.cds_eu,
    description: "Mide el riesgo de crédito en la Eurozona. Sensible a crisis energéticas y fragmentación financiera. Un aumento de este diferencial refleja miedo a problemas de liquidez en las empresas europeas.",
    history: generateTrendData(4.5, 25, 0.0001, 0.1),
  },
  {
    id: "cds_em",
    name: "Riesgo Emergentes",
    detailName: "Emerging Markets Corp OAS",
    value: "2.95%",
    change: "-0.02%",
    changeType: "flat",
    status: "favorable",
    subscore: 65,
    weight: weights.cds_em,
    description: "Mide el diferencial de crédito de empresas en mercados emergentes. Refleja el apetito global por el riesgo extremo. Cuando este indicador sube, suele haber una huida generalizada hacia activos refugio como el dólar o el oro.",
    history: generateTrendData(3, 25, -0.0001, 0.1),
  },
  {
    id: "tipos",
